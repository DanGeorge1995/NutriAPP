...
app.post("/create-user", async (req, res) => {
  ...
  db.getConnection(async (err, connection) => {
    ...
    const insert_query = mysql.format(sqlInsert, [email, hashedPassword, is_completed]);
...
app.post("/create-profile/:user_id", (req, res) => {
  ...
  db.getConnection(async (err, connection) => {
    ...
    const search_query = mysql.format(sqlInsert, [user_id, first_name, last_name, birth_date, gender, weight, height, activity]);
    await connection.query(search_query, async (err, result) => {
      connection.release();
...
app.put("/edit-profile/:user_id", (req, res) => {
  ...
  db.getConnection(async (err, connection) => {
    if (err) throw err;
    const sqlSearch = "UPDATE users_profile SET first_name = ?, last_name = ?, weight = ?,  activity = ? WHERE user_id = ?";
    const search_query = mysql.format(sqlSearch, [first_name, last_name, weight, activity, user_id]);
    await connection.query(search_query, async (err, result) => {
      connection.release();
...
app.post("/create-product/:user_id", (req, res) => {
  ...
  db.getConnection(async (err, connection) => {
    ...
    const search_query = mysql.format(sqlInsert, [user_id, name, category, image, quantity, um, calories, protein, fat, carbs]);
    await connection.query(search_query, async (err, result) => {
      connection.release();
...
app.put("/edit-product/:product_id", (req, res) => {
  ...
  db.getConnection(async (err, connection) => {
    if (err) throw err;
    const sqlSearch = "UPDATE products SET name = ?, category = ?, image = ?, quantity = ?, um = ?, calories = ?, protein = ?, fat = ?, carbs = ? WHERE product_id = ?";
    const search_query = mysql.format(sqlSearch, [name, category, image, quantity, um, calories, protein, fat, carbs, product_id]);
    await connection.query(search_query, async (err, result) => {
      connection.release();
...
app.post("/create-plan/:user_id", (req, res) => {
  ...
  db.getConnection(async (err, connection) => {
    ...
    const search_query = mysql.format(sqlInsert, [user_id, date_created, date_ended, actual_weight, final_weight, status, total_calories, pdf_plan]);
    await connection.query(search_query, async (err, result) => {
      connection.release();
